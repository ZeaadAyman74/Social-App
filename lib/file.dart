...
//       ByteData bytes = await rootBundle.load(recordFilePath); //load audio from assets
//     var  audiobytes = bytes.buffer.asUint8List(bytes.offsetInBytes, bytes.lengthInBytes);
